        ...
        <div className="card-section">
          ...
          <Grid
            ...
            >
              ...
              >
                <div className={`${classes.content}`}>
                  <div className={`${classes.contentSpacing} ${classes.firstHeader}`}>
                    <Typography
                      variant="h4"
                      sx={{ 
                        fontWeight: 700,
                  ...
                  <div className={`${classes.contentSpacing}`}>
                    ...
                    <Typography 
                      sx={{ 
                       ...
                       variant="h5">
                      A Virtual Open Forum where Mentors inspire aspiring entrepreneurs and share insight on opportunities & how to navigate challenges encountered as entrepreneurs.
                    </Typography>
                  </div>
                  <div
                    className={`${classes.buttonArea} ${classes.contentSpacing}`}
